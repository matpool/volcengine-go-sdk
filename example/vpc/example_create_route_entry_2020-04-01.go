...
func CreateRouteEntry() {
	...
	createRouteEntryInput := &vpc.CreateRouteEntryInput{
		DestinationCidrBlock: volcengine.String("8.XX.XX.8/32"),
		NextHopId:            volcengine.String("eni-2fdzbqxfwrt345oxru******"),
		NextHopType:          volcengine.String("NetworkInterface"),
		RouteEntryName:       volcengine.String("RouteEntry_1"),
