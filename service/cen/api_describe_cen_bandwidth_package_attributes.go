...
// DescribeCenBandwidthPackageAttributesCommonRequest generates a "volcengine/request.Request" representing the
...
// DescribeCenBandwidthPackageAttributesRequest generates a "volcengine/request.Request" representing the
