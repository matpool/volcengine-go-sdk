...
// DescribeCenAttributesCommonRequest generates a "volcengine/request.Request" representing the
...
// DescribeCenAttributesRequest generates a "volcengine/request.Request" representing the
