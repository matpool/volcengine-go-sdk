...
// SPARK provides the API operation methods for making requests to
// SPARK. See this package's package overview docs
// for details on the service.
//
// SPARK methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *SPARK {
	svc := &SPARK{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a SPARK operation and runs any
// custom request initialization.
func (c *SPARK) newRequest(op *request.Operation, params, data interface{}) *request.Request {
