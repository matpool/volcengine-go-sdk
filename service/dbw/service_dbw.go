...
// DBW provides the API operation methods for making requests to
// DBW. See this package's package overview docs
// for details on the service.
//
// DBW methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *DBW {
	svc := &DBW{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a DBW operation and runs any
// custom request initialization.
func (c *DBW) newRequest(op *request.Operation, params, data interface{}) *request.Request {
