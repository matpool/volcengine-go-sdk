...
// MLPLATFORM provides the API operation methods for making requests to
// ML_PLATFORM. See this package's package overview docs
// for details on the service.
//
// MLPLATFORM methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *MLPLATFORM {
	svc := &MLPLATFORM{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a MLPLATFORM operation and runs any
// custom request initialization.
func (c *MLPLATFORM) newRequest(op *request.Operation, params, data interface{}) *request.Request {
