...
// RenewVpnGatewayCommonRequest generates a "volcengine/request.Request" representing the
...
// RenewVpnGatewayRequest generates a "volcengine/request.Request" representing the
