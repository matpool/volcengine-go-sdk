...
// DescribeVpnConnectionsCommonRequest generates a "volcengine/request.Request" representing the
...
// DescribeVpnConnectionsRequest generates a "volcengine/request.Request" representing the
