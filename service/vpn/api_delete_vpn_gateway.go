...
// DeleteVpnGatewayCommonRequest generates a "volcengine/request.Request" representing the
...
// DeleteVpnGatewayRequest generates a "volcengine/request.Request" representing the
