...
// VOLCOBSERVE provides the API operation methods for making requests to
// VOLC_OBSERVE. See this package's package overview docs
// for details on the service.
//
// VOLCOBSERVE methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *VOLCOBSERVE {
	svc := &VOLCOBSERVE{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a VOLCOBSERVE operation and runs any
// custom request initialization.
func (c *VOLCOBSERVE) newRequest(op *request.Operation, params, data interface{}) *request.Request {
