...
// ExtendVolumeCommonRequest generates a "volcengine/request.Request" representing the
...
// ExtendVolumeRequest generates a "volcengine/request.Request" representing the
