...
// DeleteServerGroupCommonRequest generates a "volcengine/request.Request" representing the
...
// DeleteServerGroupRequest generates a "volcengine/request.Request" representing the
