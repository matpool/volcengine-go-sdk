...
// DeleteSnatEntryCommonRequest generates a "volcengine/request.Request" representing the
...
// DeleteSnatEntryRequest generates a "volcengine/request.Request" representing the
