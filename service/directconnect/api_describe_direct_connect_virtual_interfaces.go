...
// DescribeDirectConnectVirtualInterfacesCommonRequest generates a "volcengine/request.Request" representing the
...
// DescribeDirectConnectVirtualInterfacesRequest generates a "volcengine/request.Request" representing the
