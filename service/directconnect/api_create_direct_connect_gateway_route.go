...
// CreateDirectConnectGatewayRouteCommonRequest generates a "volcengine/request.Request" representing the
...
// CreateDirectConnectGatewayRouteRequest generates a "volcengine/request.Request" representing the
