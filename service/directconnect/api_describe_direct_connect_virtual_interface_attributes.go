...
// DescribeDirectConnectVirtualInterfaceAttributesCommonRequest generates a "volcengine/request.Request" representing the
...
// DescribeDirectConnectVirtualInterfaceAttributesRequest generates a "volcengine/request.Request" representing the
