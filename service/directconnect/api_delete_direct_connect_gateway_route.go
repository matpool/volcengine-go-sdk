...
// DeleteDirectConnectGatewayRouteCommonRequest generates a "volcengine/request.Request" representing the
...
// DeleteDirectConnectGatewayRouteRequest generates a "volcengine/request.Request" representing the
