...
// ModifyDirectConnectGatewayAttributesCommonRequest generates a "volcengine/request.Request" representing the
...
// ModifyDirectConnectGatewayAttributesRequest generates a "volcengine/request.Request" representing the
