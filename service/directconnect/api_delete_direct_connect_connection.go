...
// DeleteDirectConnectConnectionCommonRequest generates a "volcengine/request.Request" representing the
...
// DeleteDirectConnectConnectionRequest generates a "volcengine/request.Request" representing the
