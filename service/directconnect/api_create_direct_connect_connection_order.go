...
// CreateDirectConnectConnectionOrderCommonRequest generates a "volcengine/request.Request" representing the
...
// CreateDirectConnectConnectionOrderRequest generates a "volcengine/request.Request" representing the
