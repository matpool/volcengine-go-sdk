...
// DescribeDirectConnectGatewaysCommonRequest generates a "volcengine/request.Request" representing the
...
// DescribeDirectConnectGatewaysRequest generates a "volcengine/request.Request" representing the
